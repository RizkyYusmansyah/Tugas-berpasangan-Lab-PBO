...
public class MainApotek {
    ...
    public static void apotek() {
        ...
        System.out.println(
                "----------------------------------Selamat datang di Apotek DoubleR Online----------------------------------");
        System.out.println("- Disini anda dapat memesan secara online obat yang ingin dibeli pada Apotek DoubleR");
        System.out.println(
                "- Checkout obat yang ingin dibeli kemudian cetak invoice untuk dibawa ke cabang Apotek DoubleR terdekat");
        System.out.println("- Anda dapat melakukan pembayaran secara offline dengan memperlihatkan invoice");
        System.out.println("- Dengan Apotek DoubleR Online, anda tidak perlu menunggu antrian pada saat pembelian obat");
        System.out.println(
                "-----------------------------------------------------------------------------------------------------------");
        ...
        do {
            ...
            if (jenis == 1) { // obat tablet
                ...
                System.out.println("\n\t\t\tStruk ini dapat ditukarkan di cabang Apotek DoubleR terdekat");
                System.out.println("\t\t\tTerima Kasih telah menggunakan layanan Apotek DoubleR Online");
                System.out.println("\t\t\t\tSemoga Anda Puas dan Semoga Lekas Sembuh :)");
                System.out.println(
                        "--------------------------------------------------------------------------------------------------------");
                ma.setYakin(false);
            }
